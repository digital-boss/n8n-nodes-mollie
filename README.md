...
Clone the n8n-nodes-mollie repository and execute:
```
...
Create an N8N installation and add the n8n-nodes-mollie to it:
```
...
npm link @digital-boss/n8n-nodes-mollie
...
If you have any issues, please [let us know on GitHub](https://github.com/digital-boss/n8n-nodes-mollie/issues).
